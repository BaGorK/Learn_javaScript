...
console.log(airline.slice(0, airline.indexOf(' ')));//to retriev the first word from the given string
console.log(airline.slice(airline.lastIndexOf(' ') + 1));//to get the last word from the given string

console.log(airline.slice(-2));//'al' from right to left(<--)
...
const maskCreditCard = function (number) {
  const str = number + ''; //a simple trick to convert a number into a string
