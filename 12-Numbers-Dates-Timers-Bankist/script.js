...
const account2 = {
  ...
  movementsDates: [
    ...
    "2023-06-14T16:33:06.386Z",
    "2023-06-15T14:43:26.374Z",
    "2023-06-16T18:49:59.371Z",
...
const formatMovementDate = function (dateNow, local) {
  const calcDaysPassed = (date1, date2) =>
    Math.round(Math.abs((date2 - date1) / (1000 * 60 * 60 * 24)));

  const daysPassed = calcDaysPassed(new Date(), dateNow);
  ...
  if (daysPassed === 0) return "today";
    ...
    return Intl.DateTimeFormat(local).format(dateNow);
  }
};
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayDates = formatMovementDate(dateNow, acc.local);

    // const formatedMov = new Intl.NumberFormat(acc.local, {
    //   style: "currency",
...
const calcDisplayBalance = function (acc) {
  ...
  // const formatedBalance = new Intl.NumberFormat(acc.local, {
  //   style: "currency",
  //   currency: acc.currency,
  // }).format(acc.balance);
  const formatedBalance = formatCur(acc.balance, acc.local, acc.currency);
...
/*
 ...
 // float the only data type of Numbers in Javascript
console.log(23 === 23.0); // true
 
// Numbers in javascript are internally represented in 64 base 2 format

// Base 10 = Is the numbers from 0 to 9
// Binary base 2 = composed of 0's and 1's
...
// const future = new Date(2016, 10, 21, 6, 23);
// const future1 = new Date(2017, 10, 21, 6, 23);
// console.log(future.getTime());
// console.log(future);

// console.log(future1 - future); // gives timestamp in miliseconds
// // so we can convert it to number of days
// console.log((future1 - future) / (1000 * 60 * 60 * 24)); // 365

// const calcDates = (date1, date2) => Math.abs((date2 - date1) / (1000 * 60 * 60 * 24));
// console.log(calcDates(future1, future))

///////////////////////////////////////////
//  // Internationalizing Numbers
const num = 53246623234.63;
const options = {
  style: "currency",
  // unit: 'mile-per-hour',
  currency: "EUR",
...
console.log("US: ", new Intl.NumberFormat("en-US", options).format(num)); // Us: 53,246,623,234.63
console.log("Germany", new Intl.NumberFormat("de-DE", options).format(num)); // Germany 53.246.623.234,63
